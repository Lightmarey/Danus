...
| fact binding | `statement, proof, display_title, predecessors, target_version, obligation_id, route_id, assignment_epoch, claim_role, assumptions_used, closes_obligation, closure_statement?` | worker ↔ gateway ↔ control |
